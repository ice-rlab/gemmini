...
class Im2ColReadReq[T <: Data, U <: Data, V <: Data, Q <: Data](config: GemminiArrayConfig[T, U, V, Q]) extends Bundle {
...
class Im2ColReadResp[T <: Data, U <: Data, V <: Data, Q <: Data](config: GemminiArrayConfig[T, U, V, Q]) extends Bundle {
...
class Im2Col[T <: Data, U <: Data, V <: Data, Q <: Data](config: GemminiArrayConfig[T, U, V, Q]) extends Module {
  import config._
