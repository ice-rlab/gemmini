...
class TransposePreloadUnroller[T <: Data, U <: Data, V <: Data, Q <: Data](config: GemminiArrayConfig[T, U, V, Q])
...
object TransposePreloadUnroller {
  def apply[T <: Data, U <: Data, V <: Data, Q <: Data](in: ReadyValidIO[GemminiCmd], config: GemminiArrayConfig[T, U, V, Q], counter: CounterEventIO)(implicit p: Parameters): DecoupledIO[GemminiCmd] = {
