...
case class ScaleArguments[Q <: Data, T <: Data, U <: Data](scale_func: (Q, U) => T, latency: Int, multiplicand_t: U,
                                                num_scale_units: Int,
                                                identity: String="0", c_str: String="ROUNDING_RIGHT_SHIFT(x, scale)")

case class AccScaleArguments[T <: Data, U <: Data](scale_func: (T, U) => T, latency: Int, multiplicand_t: U,
                                                num_scale_units: Int,
                                                identity: String="0", c_str: String="ROUNDING_RIGHT_SHIFT(x, scale)")

case class GemminiArrayConfig[T <: Data : Arithmetic, U <: Data, V <: Data, Q <: Data](
									     ...
									     scaleDownType: Q,
                                                                             ...
                                                                             mvin_scale_args: Option[ScaleArguments[Q, T, U]] = None,
                                                                             mvin_scale_acc_args: Option[ScaleArguments[Q, T, U]] = None,
                                                                             mvin_scale_shared: Boolean = false,
                                                                             acc_scale_args: Option[AccScaleArguments[T, V]] = None,
