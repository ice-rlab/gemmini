...
class Gemmini[T <: Data : Arithmetic, U <: Data, V <: Data, Q <: Data](val config: GemminiArrayConfig[T, U, V, Q])
...
class GemminiModule[T <: Data: Arithmetic, U <: Data, V <: Data, Q <: Data]
    (outer: Gemmini[T, U, V, Q])
