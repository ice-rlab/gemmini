...
class TilerController[T <: Data: Arithmetic, U <: Data, V <: Data, Q <: Data]
  (config: GemminiArrayConfig[T,U,V, Q])(implicit val p: Parameters)
...
object TilerController {
  def apply[T <: Data: Arithmetic, U <: Data, V <: Data, Q <: Data]
    (config: GemminiArrayConfig[T,U,V,Q])(implicit p: Parameters)
