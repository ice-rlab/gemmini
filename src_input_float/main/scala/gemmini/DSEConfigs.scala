...
object DSEBaseConfig {
  val baseConfig = GemminiArrayConfig[SInt, Bool, UInt, SInt](
...
object DSEConfigs{
  ...
  val highBitwidthConfig = baseConfig.copy(scaleDownType = SInt(32.W), inputType = SInt(32.W), spatialArrayOutputType = SInt(32.W),
